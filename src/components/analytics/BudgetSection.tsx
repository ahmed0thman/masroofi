    ...
    <View className="bg-surface-container rounded-3xl p-6 items-center justify-center mb-6 shadow-sm">
      ...
      <View className="mt-6 flex-row items-center gap-4">
        <View className="items-center">
          ...
          <Text className="font-cairo-semibold text-on-surface">{monthlyBudget} {t('common.egp')}</Text>
        </View>
        ...
        <View className="items-center">
          ...
          <Text className="font-cairo-semibold text-on-surface">{spent} {t('common.egp')}</Text>
        </View>
      </View>
    </View>
  );
